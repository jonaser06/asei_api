...
class Notes extends MY_Controller
{
	...
	public function search($categorie): CI_Output
	{
		$notes_quanty = 9;
		...
		return $this->output_json(200, 'find notes for this section !', $notes);
	}
	...
	private function saveFormat(string $text = ''): string
	{
		$parrafos = explode("\n", $text);
	...
	public function get_sections(): CI_Output
	{
	...
	public function getById(int $id): CI_Output
	{
	...
	public function delete(int $id): CI_Output
	{
		...
		if ($calificationes) :
			$this->NotesModel->delete_calificaciones($id);
		endif;
		$note_imgs = $this->FileModel->getOne('ID_NO', 'multimedia_notas', ['ID_NO' => $id]);
		if ($note_imgs) {
