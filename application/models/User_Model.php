...
class User_Model extends CI_Model
{
    ...
    {
        $this->db->select('ID_US, NOMBRES,APELLIDO_PATERNO,APELLIDO_MATERNO,EMAIL,CARGO,DIRECCION,EMPRESA,FECHA_INGRESO,p.TIPO');
    ...
    {
        $this->db->select('ID_US, NOMBRES,APELLIDO_PATERNO,APELLIDO_MATERNO,EMAIL,TELEFONO,CARGO,DIRECCION,EMPRESA,FECHA_INGRESO,id_notify,p.TIPO');
        $this->db->from('usuarios as us');
        $this->db->join('perfiles as p', 'p.ID_PE = us.ID_PE');
